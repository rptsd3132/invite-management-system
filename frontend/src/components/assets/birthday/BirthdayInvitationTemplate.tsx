        ...
        >
          ...
          <div className="mt-[8%] space-y-2">
            <p
              ...
              "
            >
              {dateText || (isSinhala ? "දිනය පසුව දැනුම් දෙනු ලැබේ" : "Date to be announced")}
            </p>
            <p
              className="
                text-[clamp(12px,2vw,18px)]
              ...
              "
            >
              {timeText || (isSinhala ? "වේලාව පසුව දැනුම් දෙනු ලැබේ" : "Time to be announced")}
            </p>
            <p
              className="
                text-[clamp(12px,2vw,18px)]
              ...
              "
            >
              {location || (isSinhala ? "ස්ථානය පසුව දැනුම් දෙනු ලැබේ" : "Venue to be announced")}
            </p>
          </div>
